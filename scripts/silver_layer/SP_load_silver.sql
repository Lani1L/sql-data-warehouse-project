...
BEGIN
    ...
    BEGIN TRY
        ...
        --- STEPS TO CLEAN THE DATA silver.crm_cust_info
        ...
        --- STEPS TO CLEAN THE DATA silver.crm_prd_info
        SET @start_time = GETDATE();
        ...
        --- STEPS TO CLEAN THE DATA silver.crm_sales_details
        SET @start_time = GETDATE();
        ...
        --- STEPS TO CLEAN THE DATA silver.erp_cust_az12
        SET @start_time = GETDATE();
        ...
        SELECT 
            CASE 
                WHEN cid LIKE UPPER('NAS%') THEN SUBSTRING(cid, 4, LEN(cid)) -- Remove 'NAS' prefix if present
                ELSE cid
            END AS cid, 
            CASE 
                WHEN bdate > GETDATE() THEN NULL
                ELSE bdate
            END AS bdate, -- Set future birth_dates to NULL
            CASE 
        ...
        --- STEPS TO CLEAN THE DATA silver.erp_loc_a101
        SET @start_time = GETDATE();
        ...
        --- STEPS TO CLEAN THE DATA bronze.erp_px_cat_g1v2 (Good quality table no cleanup done)
        SET @start_time = GETDATE();
